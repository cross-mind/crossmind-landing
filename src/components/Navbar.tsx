      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <a href="/" className="flex items-center gap-3 group">
            <svg viewBox="0 0 200 200" fill="none" width="32" height="32" className="transform group-hover:scale-110 transition-transform">
            ...
            <span className="text-xl font-bold bg-gradient-to-r from-[#2D5BFF] to-[#00D4FF] bg-clip-text text-transparent">
              CrossMind
            </span>
          </a>
